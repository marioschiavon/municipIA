...
4. `src/routes/api/prospect.ts`: nenhuma mudança de pipeline — `fase: "completo"` já é o caminho padrão; apenas confirmar que a checagem de "domínio obrigatório" continua restrita a secretário/contato.
